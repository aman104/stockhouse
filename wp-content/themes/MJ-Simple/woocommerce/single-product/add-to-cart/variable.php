				...
				<tr>
					...
					<td class="value"><select id="<?php echo esc_attr( sanitize_title($name) ); ?>" name="attribute_<?php echo sanitize_title($name); ?>">
						...
						if ( sizeof($attributes) == $loop )
							echo '<a class="reset_variations" href="#reset">' . __( 'Wyczyść wybór', 'woocommerce' ) . '</a>';
					?></td>
				</tr>
	        <?php endforeach;?>
		</tbody>
...
<?php if ( is_user_logged_in() ) {
   if (!current_user_can('niezweryfikowany')) {
    echo '<div class="single_variation_wrap" style="display:none;"><div class="single_variation"></div><div class="variations_button"><input type="hidden" name="variation_id" value="" />';
