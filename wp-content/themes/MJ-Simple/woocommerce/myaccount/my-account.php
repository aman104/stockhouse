...
echo ' ';
    ...
    _e('Step 3', 'woocommerce');
    echo '</span><br />';
    echo '<span style="color:red;">';
    _e ('In this step, please complete the <a href="/moje-konto/edytuj-adres/?address=billing">payment address</a> and <a href="/moje-konto/edytuj-adres/?address=shipping">shipping address</a>. This message will appear until the account verification.', 'woocommerce');
    echo '</span>';
