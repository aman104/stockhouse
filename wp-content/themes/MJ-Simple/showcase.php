...
wp_enqueue_script( 'mjsimple-showcase', get_template_directory_uri() . '/js/showcase.js', array( 'jquery' ), '2011-04-28' );
...
<div id="primary" class="showcase">
  <div id="content" role="main">
      ...
      <section class="featured-post <?php echo $feature_class; ?>" id="featured-post-<?php echo $counter_slider; ?>">
        <?php
							...
							if ( has_post_thumbnail() ) {
								...
								?>
        <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'mjsimple' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
          ...
          <?php
				    	...
				    	while ( $featured->have_posts() ) : $featured->the_post();
							...
							if ( 1 == $counter_slider )
								...
								$class = '';
				    	?>
          <li><a href="#featured-post-<?php echo $counter_slider; ?>" title="<?php printf( esc_attr__( 'Featuring: %s', 'mjsimple' ), the_title_attribute( 'echo=0' ) ); ?>" <?php echo $class; ?>></a></li>
          <?php endwhile;	?>
        </ul>
      </nav>
    ...
    <section class="recent-posts">
      ...
      <li class="entry-title"> <a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'mjsimple' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">
        <?php the_title(); ?>
    ...
    <div class="widget-area" role="complementary">
      ...
      <?php
						the_widget( 'mj_simple_Ephemera_Widget', '', array( 'before_title' => '<h3 class="widget-title">', 'after_title' => '</h3>' ) );
						?>
