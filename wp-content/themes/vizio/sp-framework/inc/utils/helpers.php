...
function sp_load_fonts() {
	...
	return json_encode( array_unique( $fonts ) );
}
...
/*
		// loading
		$styles .=  sprintf( '%s { %s:%s; }', '.wf-loading ' . $font['selector'], 'visibility', 'hidden' ) . "\r\n";
		$styles .=  sprintf( '%s { %s:%s; }', '.wf-loading ' . $font['selector'], 'font-family', 'Arial, sans-serif' ) . "\r\n";

		// inactive
		$styles .=  sprintf( '%s { %s:%s; }', '.wf-inactive ' . $font['selector'], 'visibility', 'visible' ) . "\r\n";
		$styles .=  sprintf( '%s { %s:%s; }', '.wf-inactive ' . $font['selector'], 'font-family', 'Arial, sans-serif' ) . "\r\n";

		// active
		$styles .=  sprintf( '%s { %s:%s; }', '.wf-active ' . $font['selector'], 'visibility', 'visible' ) . "\r\n";
		$styles .=  sprintf( '%s { %s:%s; }', '.wf-active ' . $font['selector'], 'font-family', '"' . $font['font'] . '", Arial, sans-serif' ) . "\r\n";			
*/

		if ( isset( $font['selector'] ) )
			$styles .=  sprintf( '%s { %s:%s; }', $font['selector'], 'font-family', '"' . $font['font'] . '", Arial, sans-serif' ) . "\r\n";			
	}
