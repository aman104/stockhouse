...
function _sp_scripts_styles() {
	...
	$localized_vars = array(
		...
		'show_interactive_add_to_cart'		=> sp_get_option( 'show_interactive_add_to_cart' ),
...
function _sp_echo_google_fonts() {
	...
	$defaultFonts = json_encode( $fonts );
?>
...
function _sp_admin_scripts_styles() {
	...
	if ( ( isset( $_GET['page'] ) && $_GET['page'] === 'sp' ) || get_post_type() === 'post' || get_post_type() === 'page' || get_post_type() === 'sp-portfolio' || get_post_type() === 'sp-slider' || get_post_type() === 'sp-testimonial' || get_post_type() === 'sp-contact-form' || get_post_type() === 'product' ) {	
