...
function sp_facebook_og_meta() {
	...
	if ( sp_get_option( 'facebook_opengraph' ) ) {
		if ( is_object( $post ) ) {
			...
			if ( sp_woo_exists() && is_product() ) {
				...
				$metas .= '<meta property="og:title" content="' . esc_attr( $product_title ) . '" />' . "\r\n";
				$metas .= '<meta property="og:type" content="' . apply_filters( 'sp_fb_opengraph_type_for_products', 'product' ) . '" />' . "\r\n";
				$metas .= '<meta property="og:url" content="' . esc_attr( $product_url ) . '" />' . "\r\n";
				$metas .= '<meta property="og:image" content="' . esc_attr( $product_image_link['url'] ) . '" />' . "\r\n";
				$metas .= '<meta property="og:site_name" content="' . esc_attr( get_bloginfo( 'name' ) ) . '" />' . "\r\n";
				$metas .= '<meta property="og:description" content="' . esc_attr( strip_tags( $product_description ) ) . '" />' . "\r\n";
				$metas .= '<meta property="og:price:amount" content="' . esc_attr( apply_filters( 'sp_facebook_og_price_display', number_format( strip_tags( (double)$product_price ), 2, '.', '' ), $product_price ) ) . '" />' . "\r\n";
			...
			// all others
				...
				$metas .= '<meta property="og:type" content="' . apply_filters( 'sp_fb_opengraph_type_for_general', 'website' ) . '" />' . "\r\n";
				$metas .= '<meta property="og:url" content="' . esc_attr( home_url() ) . '" />' . "\r\n";
				$metas .= '<meta property="og:image" content="' . esc_attr( $logo_url ) . '" />' . "\r\n";
				$metas .= '<meta property="og:site_name" content="' . esc_attr( get_bloginfo( 'name' ) ) . '" />' . "\r\n";
				$metas .= '<meta property="og:description" content="' . esc_attr( get_bloginfo( 'description' ) ) . '" />' . "\r\n";   
			}

			$metas .= '<meta property="fb:admins" content="' . esc_attr( sp_get_option( 'facebook_opengraph_admin_id'  ) ) . '" />' . "\r\n";
			$metas .= '<meta property="fb:app_id" content="' . esc_attr( sp_get_option( 'facebook_opengraph_app_id' ) ) . '" />' . "\r\n"; 			
		}
	}
...
function _sp_seo() {
	...
	if ( is_object( $post ) ) {
		...
		if ( isset( $page_robot ) && $page_robot !== '0' )
			$output .= '<meta name="robots" content="' . esc_attr( $page_robot ) . '" /> ' . "\r\n";
...
function sp_device_width_meta() {
	...
	if ( sp_get_option( 'mobile_zoom', 'is', 'on' ) )
		...
		$metas .= '<meta name="viewport" content="width=device-width, intital-scale=1.0, maximum-scale=1.0, user-scalable=no" />' . "\r\n";
