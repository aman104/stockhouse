...
$image = sp_get_image( 
				...
				apply_filters( 'sp_woo_related_product_image_width', sp_get_theme_init_setting( 'woo_related_product_image_size', 'width' ) ), 
				apply_filters( 'sp_woo_related_product_image_height', sp_get_theme_init_setting( 'woo_related_product_image_size', 'height' ) ), 
				apply_filters( 'sp_woo_related_product_image_crop', sp_get_theme_init_setting( 'woo_related_product_image_size', 'crop' ) )
			);
...
<li <?php post_class(); ?>>
	...
	<a href="<?php the_permalink(); ?>" class="product-image-link">
		...
		<?php
			...
			echo '<img src="' . esc_url( $image['url'] ) . '" alt="' . esc_attr( $image['alt'] ) . '" itemprop="image" class="attachment-shop_catalog wp-post-image" width="' . esc_attr( $image['width'] ) . '" height="' . esc_attr( $image['height'] ) . '" />' . "\r\n";
