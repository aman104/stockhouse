...
if ( $image_url ) {
	$image_width = sp_get_image_size( $image_url[0] );
...
<li <?php post_class( $classes ); ?>>
	...
	<a href="<?php the_permalink(); ?>" class="product-image-link">
		...
		<?php
			...
			echo '<img src="' . esc_url( $image['url'] ) . '" alt="' . esc_attr( $image['alt'] ) . '" itemprop="image" class="attachment-shop_catalog wp-post-image" />' . "\r\n";
