...
<aside id="sidebar-right" class="sidebar hidden-print <?php echo esc_attr( $hide_sidebars ); ?> <?php echo esc_attr( $span_column ); ?>">
	<div class="widget-wrapper">
		...
		if ( sp_get_option( 'sitewide_sidebars_enable', 'is', 'on' ) && $sitewide_widgets !== 'on' )
			dynamic_sidebar( 'sidebar-right-sitewide' );
