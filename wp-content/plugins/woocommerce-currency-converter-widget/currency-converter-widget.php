				...
				<?php
					...
					if ( $currencies ) {
						...
						foreach ( $currencies as $currency ) {
							...
							echo '<li><a href="#mj-maincontent" class="' . esc_attr( $class ) . '" data-currencycode="' . esc_attr( $currency ) . '">' . $currency . '</a></li>';
						}

						if ( $show_reset )
							echo '<li><a href="#mj-maincontent" class="reset">' . __('Reset', 'wc_currency_converter') . '</a></li>';
